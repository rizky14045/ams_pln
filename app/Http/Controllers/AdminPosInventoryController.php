...
use App\Traits\GetMasterOptions;
    ...
    class AdminPosInventoryController extends \crocodicstudio\crudbooster\controllers\CBController {
        ...
        public function cbInit() {
            ...
            $this->col[] = [
                ...
                "callback" => function($row) {
                    ...
                    return "<img style='width: 50px;' src='".$asset->qrcode()->getUrl()."'/>";
                }
            ];
        ...
        */
        public function hook_query_index(&$query) {
            $listIdGudang = Ruang::gudang()->pluck('id')->toArray();
            $query->whereIn('id_ruang', $listIdGudang);
        }
        ...
        */
        ...
        public function getAdd()
        {
            ...
            $data['gudang'] = Ruang::gudang()->first();
            $this->cbLoader();
            return view('pos-asset-inventory.form-add', $data);
        }
        ...
        public function getEdit($id)
        {
            ...
            $data['asset'] = $asset;
            $this->cbLoader();
            return view('pos-asset-inventory.form-edit', $data);
        }
