...
use App\Traits\GetMasterOptions;
	...
	class AdminCheckoutAktivaTetapController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "checkout_aktiva_tetap";
	        ...
	        */
            ...
            $this->addaction[] = [
                'label' => 'Approve',
                'url' => route('checkout-aktiva-tetap::post-approve', null).'/[id]',
                'icon' => 'fa fa-check',
        ...
        public function getIndex()
        {
            ...
            view()->composer('crudbooster::admin_template', function($view) {
                $view->with('bottom_views', [
                    'checkout-aktiva-tetap.modal-approver' => []
                ]);
            });
	    ...
	    */
        ...
        public function getAdd()
        {
            ...
            $data['kd_checkout'] = CheckoutAktivaTetap::generateKodeCheckout();
            $this->cbLoader();
            return view('checkout-aktiva-tetap.form-add', $data);
        }
        ...
        public function getEdit($id)
        {
            ...
            $this->cbLoader();
            return view('checkout-aktiva-tetap.form-edit', $data);
        }

        protected function getListItems(CheckoutAktivaTetap $checkout)
        {
