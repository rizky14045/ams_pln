...
use App\Traits\GetMasterOptions;
	...
	class AdminRequestInventoryController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    */
        ...
        public function getAdd()
        {
            ...
            $data['kd_request'] = RequestInventory::generateKodeRequest();
            $this->cbLoader();
            return view('request-inventory.form-add', $data);
        }

        public function getEdit($id)
        {
            $request = RequestInventory::findOrFail($id);
            ...
            $this->cbLoader();
            return view('request-inventory.form-edit', $data);
        }

        protected function getListItems(RequestInventory $request)
        {
            return $request->items()->orderBy('id', 'asc')->get()->map(function($item) {
                return [
                    'kategori' => $item->kategori->toArray(),
