...
use App\Traits\GetMasterOptions;
	...
	class AdminAdjustmentInventoryController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "adjustment_inventory";
	    ...
	    */
        ...
        public function getAdd()
        {
            ...
            $data['kd_adjustment'] = AdjustmentInventory::generateKodeAdjustment();
            $this->cbLoader();
            return view('adjustment-inventory.form-add', $data);
        }
        ...
        public function getEdit($id)
        {
            ...
            $this->cbLoader();
            return view('adjustment-inventory.form-edit', $data);
        }

        protected function getListItems(AdjustmentInventory $adjustment)
        {
            return $adjustment->items()->orderBy('id', 'asc')->get()->map(function($item) {
                return [
                    'asset' => $item->asset->toArray(),
                    'kategori' => $item->asset->kategori->toArray(),
