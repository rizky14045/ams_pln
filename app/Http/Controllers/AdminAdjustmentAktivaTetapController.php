...
use App\Traits\GetMasterOptions;
	...
	class AdminAdjustmentAktivaTetapController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "adjustment_aktiva_tetap";
	    ...
	    */
        ...
        {
            $data['kd_adjustment'] = AdjustmentAktivaTetap::generateKodeAdjustment();
            $this->cbLoader();
            return view('adjustment-aktiva-tetap.form-add', $data);
        }
        ...
        public function getEdit($id)
        {
            ...
            $this->cbLoader();
            return view('adjustment-aktiva-tetap.form-edit', $data);
        }

        protected function getListItems(AdjustmentAktivaTetap $adjustment)
        {
            return $adjustment->items()->orderBy('id', 'asc')->get()->map(function($item) {
                return [
                    'model' => $item->model->toArray(),
