<?php namespace App\Http\Controllers;
	...
	class AdminJenisExtracomptableController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "jenis_extracomptable";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Kode Jenis","name"=>"kd_jenis"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Kode Jenis','name'=>'kd_jenis','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Kd Jenis","name"=>"kd_jenis","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
