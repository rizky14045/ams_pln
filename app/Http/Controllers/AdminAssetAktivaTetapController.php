...
use App\Traits\GetMasterOptions;
	...
	class AdminAssetAktivaTetapController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Model","name"=>"id_model","join"=>"model_aktiva_tetap,nama_model"];
			...
			$this->col[] = [
                ...
                "callback" => function($row) {
                    $configs = config('asset.status_aktiva_tetap');
			...
			$this->form[] = ['label'=>'Model','name'=>'id_model','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'model_aktiva_tetap,id'];
			...
			//$this->form[] = ["label"=>"Model","name"=>"id_model","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"model,id"];
	    ...
	    */
        ...
        public function getDetail($id)
        {
            ...
            return view('asset-aktiva-tetap/page-detail', $data);
        }

        public function getAdd()
        {
            $id_model = prev_input('id_model');

            $data['page_title'] = "Add Asset Aktiva Tetap";
            $data['options_model'] = $this->getOptionsModel();
            $data['options_status'] = $this->getOptionsStatusAktivaTetap();
            $this->cbLoader();
            return view('asset-aktiva-tetap.form-add', $data);
        }
        ...
        public function getEdit($id)
        {
            ...
            $data['page_title'] = "Edit Asset Aktiva Tetap";
            $data['asset'] = $asset;
            $data['options_model'] = $this->getOptionsModel();
            $data['options_status'] = $this->getOptionsStatusAktivaTetap();
            $this->cbLoader();
            return view('asset-aktiva-tetap.form-edit', $data);
        }
