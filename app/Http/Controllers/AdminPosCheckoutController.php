...
use App\Traits\GetMasterOptions;
	...
	class AdminPosCheckoutController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Kd Checkout","name"=>"kd_checkout"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Kd Checkout','name'=>'kd_checkout','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
	    ...
	    */
	    public function hook_query_index(&$query) {
	        $query->where('kd_checkout', 'like', 'PCI%');
	    }
	    ...
	    */
        ...
        public function getAdd()
        {
            ...
            $data['kd_checkout'] = CheckoutInventory::generateKodeCheckout(new \Datetime, true);
            $this->cbLoader();
            return view('pos-checkout-inventory.form-add', $data);
        }
        ...
        public function getEdit($id)
        {
            ...
            $this->cbLoader();
            return view('pos-checkout-inventory.form-edit', $data);
        }
