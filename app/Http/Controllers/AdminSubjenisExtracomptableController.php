<?php namespace App\Http\Controllers;
	...
	class AdminSubjenisExtracomptableController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Jenis','name'=>'id_jenis','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'jenis_extracomptable,nama'];
			$this->form[] = ['label'=>'Kode Subjenis','name'=>'kd_subjenis','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
