...
use App\Traits\GetMasterOptions;
	...
	class AdminCheckoutExtracomptableController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "checkout_extracomptable";
	        ...
	        */
            ...
            $this->addaction[] = [
                'label' => 'Approve',
                'url' => route('checkout-extracomptable::post-approve', null).'/[id]',
                'icon' => 'fa fa-check',
        ...
        public function getIndex()
        {
            ...
            view()->composer('crudbooster::admin_template', function($view) {
                $view->with('bottom_views', [
                    'checkout-extracomptable.modal-approver' => []
                ]);
            });
	    ...
	    */
        ...
        public function getAdd()
        {
            ...
            $data['kd_checkout'] = CheckoutExtracomptable::generateKodeCheckout();
            $this->cbLoader();
            return view('checkout-extracomptable.form-add', $data);
        }
        ...
        public function getEdit($id)
        {
            ...
            $this->cbLoader();
            return view('checkout-extracomptable.form-edit', $data);
        }

        protected function getListItems(CheckoutExtracomptable $checkout)
        {
