...
use App\Models\Ruang;
	...
	class AdminRuangController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Kd Ruang","name"=>"kd_ruang"];
			$this->col[] = ["label"=>"Nama Ruang","name"=>"nama_ruang"];
            ...
            $this->col[] = [
                ...
                "callback" => function($row) {
                    $ruang = Ruang::find($row->id);
                    $qrcodeUrl = $ruang->qrcode()->getUrl();
			...
			$this->form[] = ['label'=>'Kd Ruang','name'=>'kd_ruang','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Nama Ruang','name'=>'nama_ruang','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Kd Ruang","name"=>"kd_ruang","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Nama Ruang","name"=>"nama_ruang","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
