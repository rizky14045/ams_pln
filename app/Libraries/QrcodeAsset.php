...
class QrcodeAsset
{
    ...
    {
        $code = $this->code;
        $optionTexts = $this->getOption('texts');
        ...
        $logoPath = public_path('img/logo-pjb-ex.jpg');
        $logo = Image::make($logoPath);
        $logo->resize(null, 96, function($c) {
            $c->aspectRatio();
        });
        ...
        $canvas->insert($logo, 'top-left', $width + $padding * 2, $padding);
