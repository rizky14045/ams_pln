...
@section('content')
  @component('components.panel-form')
    @slot('title')
      <i class="fa fa-plus"></i> Add Pemeliharaan Extra Comptable
    @endslot

    @include('partials.show-errors')

    <form action="{{ route('pemeliharaan-extracomptable::post-create') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
