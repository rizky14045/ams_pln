...
@section('content')
  @component('components.panel-form')
    @slot('title')
      <i class="fa fa-edit"></i> Edit Checkout Inventory
    @endslot

    <form action="{{ route('checkout-inventory::post-edit', [$checkout->id]) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
      ...
      @component('partials.fields.wrapper', ['name' => '', 'label' => ''])
        <a href="{{ route('AdminCheckoutInventoryControllerGetIndex') }}" class="btn btn-default"><i class="fa fa-chevron-left"></i> Batal</a>
        &nbsp;
    ...
    var form = new Vue({
      ...
      methods: {
        ...
        submitAddItem: function(e) {
          ...
          var url = "{{ route('asset-inventory::json-get-detail-asset', ['']) }}";
