...
@section('content')
  @component('components.panel-form')
    @slot('title')
      <i class="fa fa-plus"></i> Add Checkout Extra Comptable
    @endslot

    <form action="{{ route('checkout-extracomptable::post-create') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
