...
@section('content')
  @component('components.panel-form')
    @slot('title')
      <i class="fa fa-edit"></i> Edit Checkout Extra Comptable
    @endslot

    <form action="{{ route('checkout-extracomptable::post-edit', [$checkout->id]) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
      ...
      <div class="form-group">
        <div class="col-md-push-2 col-md-10">
          <a href="{{ route('AdminCheckoutExtracomptableControllerGetIndex') }}" class="btn btn-default"><i class="fa fa-chevron-left"></i> Batal</a>
          &nbsp;
