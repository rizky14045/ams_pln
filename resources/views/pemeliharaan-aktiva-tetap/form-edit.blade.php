...
@section('content')
  @component('components.panel-form')
    @slot('title')
      <i class="fa fa-edit"></i> Edit Pemeliharaan Aktiva Tetap
    @endslot

    <form action="{{ route('pemeliharaan-aktiva-tetap::post-edit', [$pemeliharaan->id]) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
