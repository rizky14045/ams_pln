...
@section('content')
  @component('components.panel-form')
    @slot('title')
      <i class="fa fa-plus"></i> Add Adjustment Inventory
    @endslot

    @include('partials.show-errors')

    <form action="{{ route('adjustment-inventory::post-create') }}" method="POST" class="form-horizontal">
      ...
      @include('partials.fields.date', [
        ...
        'required' => true,
        'label' => 'Tanggal',
        'value' => prev_input('tanggal') ?: date('Y-m-d')
      ])
          ...
          <tbody class="vhide hidden">
            ...
            <tr v-for="item, index in list_items">
              ...
              <td>
                ...
                <input type="hidden" :name="'items['+index+'][description]'" :value="item.note"/>
