...
@section('content')
  @component('components.panel-form')
    @slot('title')
      <i class="fa fa-plus"></i> Add Adjustment Extra Comptable
    @endslot

    @include('partials.show-errors')

    <form action="{{ route('adjustment-extracomptable::post-create') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
