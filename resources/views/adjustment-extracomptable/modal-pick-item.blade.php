    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <select name="id_jenis" class="use-select2 form-group">
            <option value="">-- Pilih Jenis Barang --</option>
          </select>
        </div>
        <div class="form-group">
          <label for="">Sub Jenis Barang</label>
          <select name="id_subjenis" class="use-select2 form-group">
...
var ModalPickItem = function() {
  ...
  this.$el.find("select[name='id_subjenis']").change(function() {
...
ModalPickItem.prototype.setSelectOptions = function(el, options, value) {
  ...
  if ($("select[name='id_subjenis']").val()) {
    this.fetchCurrentQty();
  }
}
...
ModalPickItem.prototype.fetchCurrentQty = function(callback) {
  ...
  var id_subjenis = this.$el.find("select[name='id_subjenis']").val();
  var url = "{{ route('asset-extracomptable::json-get-quantity') }}";
  $.getJSON(url, {id_ruang: id_ruang, id_subjenis: id_subjenis}).done(function(res) {
