...
@section('content')
  @component('components.panel-form')
    @slot('title')
      <i class="fa fa-edit"></i> Edit Asset Aktiva Tetap
    @endslot

    <form action="{{ route('asset-aktiva-tetap::post-edit', [$asset->id]) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
