<template id="grid-extracomptable-per-lokasi">
...
@script('component-grid-extracomptable-per-lokasi')
  @parent
  <script>
  Vue.component('grid-extracomptable-per-lokasi', {
    template: '#grid-extracomptable-per-lokasi',
    props: {
      urlFetch: {
        type: String,
        required: true
