...
@section('content')
  @component('components.panel-form')
    ...
    <form action="{{ route('asset-extracomptable::post-create') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
      <div class="row">
...
@section('scripts')
  ...
  function generateKodeAsset() {
    ...
    var can_generate = (id_gedung && lantai && id_ruang && id_jenis && id_subjenis && tgl_masuk);
    if (!can_generate) {
      return '';
    }
  ...
  function updateButtonGenerate() {
    ...
    var clickable = (id_gedung && lantai && id_ruang && id_jenis && id_subjenis && tgl_masuk);
