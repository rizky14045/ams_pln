...
@section('content')
  @component('components.panel-form')
    @slot('title')
      <i class="fa fa-edit"></i> Edit Asset Inventory
    @endslot

    <form action="{{ route('pos-asset-inventory::post-edit', [$asset->id]) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
